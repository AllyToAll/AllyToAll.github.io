...
- Third-party assets should be assumed to be **separately licensed** from the project code
...
- Epic
  Games — https://dev.epicgames.com/docs/services/en-US/EpicAccountServices/DesignGuidelines/index.html#epicgamesbrandguidelines
- Github — https://github.com/logos
- Mastodon — https://joinmastodon.org/branding
- OnlyFans — https://onlyfans.com/brand
...
All trademarks and logos are the property of their respective owners and are used here for identification and
